...
function NewsFeedLayout() {
  ...
  return (
    <div className='w-full flex pt-5 bg-bg-light-green h-full border-2 border-solid border-blue-500'>
      ...
      <div className='w-full flex flex-col md:flex-row border-2 border-solid border-green-500 '>
